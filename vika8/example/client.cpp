...
/*
Note: This code is provided purely as an example of things
you may need to do in this assignment. 
This code neither implements the right messages 
or message formats nor is it bug-free. 
I suggest using it only as a guideline and writing your own
from scratch, thinking about the flow of messages through 
the server and how you want to handle that.
Also, using poll() instead of select() might make your life a bit easier.
*/
#include <stdio.h>
#include <errno.h>
#include <stdlib.h>
